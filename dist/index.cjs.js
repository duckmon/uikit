...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 30" }, props),
        React__default['default'].createElement("image", { width: "160", height: "30", href: isDark ? "/logo-text-dark.png" : "/logo-text.png" })));
};
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/duckmoneydefi",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#c9050f", textDisabled: "#BDC2C4", textSubtle: "#ce404c", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
